...
import SendPassToEmail from "./components/users/SendPassToEmail";
    ...
    <WepProvider>
      ...
      <Container className="mb-4">
        <Routes>
          ...
          <Route path="/editstore-item"   element={localUser==="admin"?<EditStore/>:localUser==="business"?<EditStore/>:<Errorpage/>} />
          <Route path="/updateItem" element={localUser==="admin"?<UpdateItem/>:localUser==="business"?<UpdateItem/>:<Errorpage/>}/>
          <Route path="/about" element={<About></About>} />
          <Route path="/sign-in"   element={<Login/>}/>
          <Route path="/send-pass"   element={<SendPassToEmail/>}/>
